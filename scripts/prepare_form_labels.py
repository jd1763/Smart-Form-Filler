...
merge_map = {
    ...
    "dob": "birth_date",
    "work_auth_us": "work_auth", "work_auth_canada": "work_auth",
    "work_auth_uk": "work_auth",
    "ethnicity": "demographics", "gender": "demographics",
    "disability": "demographics", "lgbtq": "demographics",
...
synonyms = {
    ...
    "phone": [
        ...
        "Work Phone", "Home Phone", "Primary Phone", "Secondary Phone",
        "Business Phone", "Direct Line", "Office Phone", "Main Phone",
    ...
    "address": [
        ...
        "Residential Address", "Permanent Address", "Work Address",
        "Company HQ Address",
    ],
    "birth_date": [
    ...
    "education": [
        ...
        "Graduated In", "Year Completed", "Certifications",
        "Professional Certificates", "Diploma", "Training Program", "Field of Study",
    ],
    "demographics": [
        ...
        "Military Service", "Military Background", "Protected Veteran",
        "Community Group",
    ],
    "referral_source": [
        "Referral Source", "How did you learn about us?",
        "Where did you hear about us?", "How did you hear about this job?",
        "Job Board Source", "Friend Referral", "Colleague Referral",
        "Career Fair", "Recruiter", "Advertisement", "Online Ad",
        "Social Media Ad", "Employee Referral", "Internal Referral",
        "Website Referral",
    ],
    "role_description": [
        ...
        "Task Description", "Employment Duties", "Daily Tasks",
        "Main Role", "Primary Duties",
    ],
    "job_title": [
        "Job Title", "Previous Job Title", "Your Job Title", "Position Title",
        "Role", "Job Position", "Employment Title", "Official Job Title",
        "Work Title", "Current Position", "Past Position", "Title at Company",
        "Professional Title", "Designation", "Career Title",
    ],
    "start_date": [
        "Start Date", "When did you start at your latest role?",
        "Employment Start", "Job Start", "Contract Start",
        "Employment Start Date", "Work Start", "Date Hired",
        "Hire Date", "Start of Employment", "Start of Work",
        "Begin Date", "Joining Date", "Commencement Date",
    ],
    "end_date": [
        "End Date", "End date of your latest role", "Employment End",
        "Date Left", "Contract End", "Job End", "Employment End Date",
        "Termination Date", "Date Finished", "End of Employment",
        "End of Contract", "Date of Exit", "Finish Date",
    ],
    "social": [
        "LinkedIn Profile URL", "Portfolio / GitHub / Personal Website",
        "LinkedIn URL", "GitHub Link", "Personal Site", "Professional Profile",
        "Portfolio Website", "Social Link", "Online Profile",
        "Professional Website", "Digital Portfolio", "Work Samples",
        "LinkedIn Profile", "Online Resume", "Career Profile",
    ],
    "document": [
        "Upload Resume", "Cover Letter / Additional Information", "Resume Upload",
        "Supporting Document", "Application Document", "CV Upload",
        "Job Application File", "Resume File", "Cover Letter",
        "Supporting Files", "Attachment", "Required Document",
        "Application Materials", "Resume Attachment",
    ],
    "background_check": [
        "Background check consent", "Consent to background check",
        "I agree to a background check", "Background Screening",
        "Pre-employment Background Check", "Background Verification",
        "Criminal Record Check", "Identity Verification",
        "Background Consent", "Security Screening",
        "Background Check Authorization", "Screening Consent",
        "Background History", "Employment Screening",
    ],
    "terms_consent": [
        "I agree to the Terms & Conditions and Privacy Policy",
        "Accept Terms & Conditions", "Agree to Terms of Service",
        "I agree to the Privacy Policy", "Terms Agreement",
        "Accept Privacy Policy", "Consent to Terms", "Agree to Terms",
        "Accept User Agreement", "Consent to Conditions",
        "User Consent", "Privacy Terms Agreement",
    ],
    "work_auth": [
        ...
        "Work Permit", "Visa Status", "Right to Work",
        "Legal Work Authorization", "Sponsorship Required",
        "Eligible to Work", "Authorized to Work", "Work Visa",
        "Permit to Work",
    ],
}
